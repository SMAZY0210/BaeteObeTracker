...
const Api = {
  ...
  getBatches()                        { return this.get('/admin/batches'); },
  createBatch(d)                      { return this.post('/admin/batches', d); },
  updateBatch(id, d)                  { return this.put('/admin/batches/' + id, d); },
  deleteBatch(id)                     { return this.delete('/admin/batches/' + id); },
  getAcademicSessions()               { return this.get('/admin/academic-sessions'); },
  createAcademicSession(d)            { return this.post('/admin/academic-sessions', d); },
  updateAcademicSession(id, d)        { return this.put('/admin/academic-sessions/' + id, d); },
  deleteAcademicSession(id)           { return this.delete('/admin/academic-sessions/' + id); },
  ...
  getCourseAssignments(filters)       { return this.get('/admin/course-assignments', filters); },
  createCourseAssignment(d)           { return this.post('/admin/course-assignments', d); },
  deleteCourseAssignment(id)          { return this.delete('/admin/course-assignments/' + id); },
  ...
  getEnrolments(courseId, academicSessionId) { return this.get('/admin/enrolments', academicSessionId ? { courseId, academicSessionId } : { courseId }); },
  ...
  bulkCreateUsers(users, batchId)     { return this.post('/admin/users/bulk', { users, batchId }); },
  ...
  // Faculty
  getMyCourses(academicSessionId)     { return this.get('/faculty/courses', academicSessionId ? { academicSessionId } : {}); },
